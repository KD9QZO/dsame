...
SAME__ORG = {
    ...
    'EAS': {
        'NAME': {
            'US': 'Broadcast station or cable system',
    ...
    'EAN': {
        'NAME': {
            ...
            'CA': 'Emergency Action Notification Network '
        },
        'PLURAL': False,
        'ARTICLE': {
            'US': 'THE',
...
WFO_LIST = {
    ...
    'PGUM': 'Guam',
    'KGYX': 'Portland/Gray, ME',
    'PHFO': 'Honolulu, HI',
    'KHGX': 'Houston/Galveston, TX',
    'KHNX': 'San Joaquin Valley/Hanford, CA',
    'KICT': 'Wichita, KS',
    'KILM': 'Wilmington, NC',
    'KILN': 'Wilmington/Cincinnati, OH',
    'KILX': 'Central Illinois (Lincoln, IL)',
    ...
    'KMSO': 'Missoula, MT',
    'KMTR': 'San Francisco Bay Area/Monterey, CA',
    'KOAX': 'Omaha, NE',
    'KOHX': 'Nashville, TN',
    'KOKX': 'New York City, Upton, NY',
    'KOTX': 'Spokane, WA',
    'KOUN': 'Norman (Oklahoma City), OK',
    'KPAH': 'Paducah, KY',
    'KPBZ': 'Pittsburgh, PA',
    'KPDT': 'Pendleton, OR',
    'KPHI': 'Philadelphia, PA',
    'KPIH': 'Pocatello/Idaho Falls, ID',
    'KPQR': 'Portland, OR',
    'KPSR': 'Phoenix, AZ',
    'KPUB': 'Pueblo, CO',
    'KRAH': 'Raleigh/Durham, NC',
    'KREV': 'Reno, NV',
    'KRIW': 'Riverton, WY',
    'KRLX': 'Charleston, WV',
    'KRNK': 'Blacksburg, VA',
    'KSEW': 'Seattle/Tacoma, WA',
    'KSGF': 'Springfield, MO',
    'KSGX': 'San Diego, CA',
    'KSHV': 'Shreveport, LA',
    'KSJT': 'San Angelo, TX',
